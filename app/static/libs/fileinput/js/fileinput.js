...
(function (factory) {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    downloadIcon: '<i class="fa fa-cloud-download"></i>',
                    downloadClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    downloadTitle: 'Download file',
                    zoomIcon: '<i class="fa fa-television"></i>',
                    zoomClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    zoomTitle: 'View Details',
                    dragIcon: '<i class="fa fa-remove"></i>',
                    dragClass: 'text-info',
                    dragTitle: 'Move / Rearrange',
                    dragSettings: {},
                    indicatorNew: '<i class="fa fa-sign-in text-warning"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="fa fa-caret-square-o-left"></i>',
            next: '<i class="fa fa-caret-square-o-right"></i>',
            toggleheader: '<i class="fa fa-external-link"></i>',
            fullscreen: '<i class="fa fa-toggle-on"></i>',
            borderless: '<i class="fa fa-toggle-off"></i>',
